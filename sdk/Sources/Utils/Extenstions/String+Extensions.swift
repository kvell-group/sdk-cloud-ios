...
extension String {
    static let bundleName = "KvellSdkResources"
    ...
    static let payResponseCardPay = "Оплата в процессе"
    ...
    static let orderPaid = "Оплата заказа"
    static let errorDescription = "Описание ошибки"
