...
class MainViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        AF.request("https://wp-demo.pay-pulse.example/index.php/wp-json/wc/v3/products", method: .get, parameters: nil, headers: getHeaders()).responseJSON {
            response in
    ...
    private func getHeaders() -> HTTPHeaders {
        let userName = "ck_REPLACE_ME"
        let password = "cs_REPLACE_ME"
